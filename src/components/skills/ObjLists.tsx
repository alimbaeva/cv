...
export const ObjLists: FC<IObjList> = ({ objList }: IObjList) => {
  return (
    <ul className="contact">
      <li key={objList[0].name}>
        <a href={objList[0].link} target="_blank" rel="noreferrer">
          <svg
            version="1.1"
            id="Layer_1"
          ...
          <div>
            <Icone name={objList[0].image} color="#000000" size={35} />
          </div>
          {objList[0].name}
        </a>
      </li>
      <li key={objList[1].name}>
        <a href={objList[1].link} target="_blank" rel="noreferrer">
          <svg
          ...
          <div>
            <Icone name={objList[1].image} color="#000000" size={35} />
          </div>
          {objList[1].name}
        </a>
      </li>
      <li key={objList[2].name}>
        <a href={objList[2].link} target="_blank" rel="noreferrer">
          <svg
          ...
          <div>
            <Icone name={objList[2].image} color="#000000" size={35} />
          </div>
          {objList[2].name}
        </a>
      </li>
      <li key={objList[3].name}>
        <a href={objList[3].link} target="_blank" rel="noreferrer">
          ...
          <div>
            <Icone name={objList[3].image} color="#000000" size={35} />
          </div>
          {objList[3].name}
        </a>
      </li>
